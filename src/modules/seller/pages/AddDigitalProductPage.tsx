...
import DigitalProductForm from "../components/products/DigitalProductForm";
      ...
      <div className="flex min-h-screen w-full bg-[#f9fafb] overflow-hidden">
        ...
        <aside className="hidden lg:block w-[260px] flex-shrink-0 bg-white border-r border-gray-200">
          <div className="sticky top-0 h-screen p-4">
            <SidebarNavigation scrollContainerRef={formContainerRef}  productType="DIGITAL"
 />
          </div>
        </aside>
        ...
        <div className="flex flex-col flex-1 min-h-screen overflow-hidden">
          ...
          >
            <DigitalProductForm productId={id} />
          </div>
        </div>
      </div>
    </Layout>
