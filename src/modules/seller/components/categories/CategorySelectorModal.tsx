...
const CategorySelectModal: React.FC<CategorySelectModalProps> = ({
  ...
  // Keep local selection in sync when the modal opens or selection changes outside
  useEffect(() => {
    if (open) setLocalSelected(selectedCategoryIds);
      ...
      <div key={cat.id}>
        <div
          ...
          onClick={(e) => {
            ...
            if (isArrowClick) return; // don't toggle selection when arrow used
        ...
        >
          <div className="flex items-center space-x-4 flex-1">
            ...
            <div>
              ...
              {/* ⬇️ Parent shows number of subcategories, not product count */}
              ...
              >
                <div className="flex items-center space-x-4 flex-1">
                  ...
                  <div>
                    ...
                    {/* ⬇️ No count line for subcategory (removed) */}
                  </div>
                </div>
