...
const ALL_ITEMS = [
  ...
  { label: "Workshop Duration", id: "workshop-duration", icon: Info },
  { label: "Meeting Breakdown", id: "meeting-breakdown", icon: Truck },
  { label: "WorkShop Breakdown", id: "workshop-breakdown", icon: Truck },
  { label: "Meeting Channel", id: "meeting-channel", icon: Truck },
  { label: "WorkShop Channel", id: "workshop-channel", icon: Truck },
