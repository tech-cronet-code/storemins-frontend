  ...
  return (
    <>
      {/* <div className="flex items-center justify-center">
        <RegisterLoginToggleBtn
          isRegister={isLogin}
          setIsRegister={setIsLogin}
        />
      </div> */}
      {/* <div className="lg:w-full md:w-3xl flex items-center justify-center bg-[#FFF] lg:mx-15 md:mx-auto pt-5">
      ...
      {/* <p className="text-lg text-center text-[#475467] mb-6">
      ...
      <div className="flex items-center justify-center mt-2">
        ...
        <div className="px-3 text-sm text-gray-500 flex gap-1 whitespace-nowrap">
          <span>Or</span>
